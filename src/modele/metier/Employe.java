...
// -----------------------------------------------------------------------------------------------------------------------
	 ...
	 * @param dateNaissance
	 */
	public Employe(int idEmployee, String nom, String prenom, String mail, Date dateNaissance, Adresse adresse) {
		super();
	 ...
	 * @param professeur
	 */
	public Employe(String nom, String prenom, String mail, Date dateNaissance, Adresse adresse) {
	super();
	this.nom = nom;
	this.prenom = prenom;
	this.mail = mail;
